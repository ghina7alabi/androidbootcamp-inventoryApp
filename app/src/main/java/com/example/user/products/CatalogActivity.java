...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void insertProduct() {
        ...
        values.put(ProductEntry.COLUMN_PRODUCT_NAME, "T-shirt With Ice-Cream Print");
        values.put(ProductEntry.COLUMN_PRODUCT_QUANTITY, 1);
        values.put(ProductEntry.COLUMN_PRODUCT_PRICE, 8);
        values.put(ProductEntry.COLUMN_PRODUCT_SUPNAME, "Ghina Al Halabi");
        values.put(ProductEntry.COLUMN_PRODUCT_SUPNUMBER, "+96171676752");
        values.put(ProductEntry.COLUMN_PRODUCT_STATUS, ProductEntry.STATUS_UNKNOWN);
